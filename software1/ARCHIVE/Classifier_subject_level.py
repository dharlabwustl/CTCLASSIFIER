...
# Prep XNAT session
XNAT_HOST ='https://snipr-dev-test1.nrg.wustl.edu' #os.environ['XNAT_HOST']os.environ['XNAT_HOST'] # 
XNAT_USER = os.environ['XNAT_USER'] #'atulkumar' #
XNAT_PASS = os.environ['XNAT_PASS'] #'Yajamahe1!' #o
...
def get_metadata_subject(subjLabel):
    url= '/data/subjects/'+ subjLabel+'/experiments/?format=json' 
    xnatSession.renew_httpsession()
    response = xnatSession.httpsess.get(xnatSession.host + url)
